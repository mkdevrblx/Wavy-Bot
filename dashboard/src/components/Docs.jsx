  ...
  return (
    <div className="docs-container animate-fade-in">
      <div className="command-hero glass-panel docs-hero">
        <div>
          <p className="command-eyebrow">Wavy Operator Guide</p>
          <h2 className="glow-text">Documentation & Help</h2>
          <p className="subtitle">Shortcuts to the parts of Wavy you actually use, plus quick explanations for what each area controls.</p>
        </div>
