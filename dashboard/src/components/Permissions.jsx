  ...
  return (
    <div className="command-center animate-fade-in">
      <div className="command-hero glass-panel">
        <div><p className="command-eyebrow">WavyClient Controls</p><h2 className="glow-text">Permission Manager</h2><p className="subtitle">Review command permissions, cooldown overrides, and channel restrictions.</p></div>
