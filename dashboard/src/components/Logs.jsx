...
export default function Logs({ selectedGuild }) {
  ...
  return (
    <div className="moderation-container animate-fade-in">
      <div className="section-header"><h2 className="glow-text"><i className="fa-solid fa-stream"></i> Live Logs</h2><p className="subtitle">Merged event stream from WavyClient dashboard telemetry and moderation cases.</p></div>
