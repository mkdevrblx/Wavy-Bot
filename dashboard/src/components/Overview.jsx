  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        console.error('[Wavy Overview]', error);
        setOverview(null);
      } finally {
        setLoading(false);
      }
  ...
  if (loading) {
    return (
      <div className="overview-loading">
        ...
        <p>Loading Wavy Bot analytics...</p>
      </div>
    );
  }
      ...
      <div className="ov-charts-row">
        <div className="ov-chart-card glass-panel">
          ...
          <div className="wavy-bars">
            {charts.map((point) => (
              <div key={point.label} className="wavy-bar-day">
                <div className="wavy-bar-stack">
          ...
          <div className="wavy-chart-legend">
            {chartSeries.map(([key, label, color]) => (
          ...
          <div className="ov-ai-header">
            <div className="ov-ai-title-row">
              ...
              <div>
                ...
                <p className="ov-subtitle">WavyBot case history</p>
              </div>
            </div>
          </div>
          <div className="ov-activity-list">
