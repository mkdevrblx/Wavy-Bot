  ...
  return (
    <div className="modal-overlay server-picker-overlay">
      <div className="modal-card server-picker-card glass-panel pop-in">
        <h2>Welcome to Wavy</h2>
        <p className="modal-subtitle">Select a server where Wavy Bot is already present.</p>
        ...
        {availableGuilds.length > 0 ? (
          ...
          <div className="server-picker-empty">
            ...
            <p>Your Discord account has dashboard access, but Wavy Bot is not present in any of those servers yet.</p>
          </div>
        )}
      </div>
    </div>
