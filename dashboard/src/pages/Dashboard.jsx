...
const guildCacheKey = 'wavy_dashboard_guilds';
const userCacheKey = 'wavy_dashboard_user';
  ...
  return (
    <div className="loading-stage">
      ...
      <div className="loading-copy">
        <p className="topbar-eyebrow">Wavy Control Surface</p>
  ...
  useEffect(() => {
    const bootstrap = async () => {
      try {
        ...
        const savedGuild = localStorage.getItem('wavy_guild_id');
        ...
        <header className="topbar">
          <div className="topbar-left">
            ...
            <div className="topbar-title-wrap">
              <p className="topbar-eyebrow">WavyClient Control Surface</p>
